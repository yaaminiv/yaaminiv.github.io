...
layout: post
comments: true
title: West Coast Green Crab Experiment Part 45
tags: green-crab-wc PCR gel
---

## Extractions, PCR, and gel for TTR crabs

I worked with the final batch of leg joints that have heart tissue samples associated with them! I had three more samples to do a first-round extraction for, so I decided to just re-extract those with a faint gel band.
...
- Samples extracted: 134, 161, 164, 181, 66, 144, 123, 154, 168
- Sample 154 didn't pellet down nicely after extractions
...
![Screenshot 2024-03-19 at 3 47 15 PM](https://github.com/yaaminiv/wc-green-crab/assets/22335838/c7e0a64a-3a56-4bc4-bb28-e45b7ba16a71)

**Figure 1**. Gel image for 134, 161, 164, 181, 66, 144, ladder, 123, 154, 168, extraction blank, and PCR blank

Oops...extraction blank AND PCR blank are contaminated. I'll probably troubleshoot this by doing a new PCR only after I send out my second batch samples. At least the bands are brighter on this one, so that's an improvement for the samples with faint gel bands last time.

### Going forward

1. Send sample batch 2 for sequencing
2. Re-extract and PCR samples with faint gel bands
