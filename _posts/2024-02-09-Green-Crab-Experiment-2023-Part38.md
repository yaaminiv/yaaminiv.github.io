...
Today I worked with Vanessa to do finish up PCR for the remaining respirometry crabs and start in on some TTR crabs!
...
- Samples extracted and taken through PCR: 117, 126, 176, 168, 2, 182, 183, 51, 63, 92
...
- After finishing Chelex extractions, we immediately loaded the vortexed samples into PCR tubes. The other samples that were just extracted were put in the Dirty fridge.

### Results

<img width="776" alt="Screenshot 2024-02-10 at 2 34 38 PM" src="https://github.com/yaaminiv/wc-green-crab/assets/22335838/f83e8b1c-b403-4678-978b-ccf4e47cfdb9">

**Figure 1**. Gel image for 117, 126, 176, 168, 2, 182, 183, ladder, 51, 63, 92, extraction blank, and PCR blank.

Vanessa did great today! She seemed more comfortable with PCR and the gel since she's done it before. Getting supernatant out of the Chelex solution was a bit tricky for her, but it's tricky for everyone. Clean extraction blank and PCR blank tells me that we should be getting consistent results moving forward with new extractions and the new primers. 168 may need to be re-extracted since the blank is really faint, but for now we're in good shape!
