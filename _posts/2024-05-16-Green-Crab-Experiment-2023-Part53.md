...
layout: post
comments: true
title: West Coast Green Crab Experiment Part 53
tags: green-crab-wc extractions PCR gel
---

## Extraction, PCR, and gel for remaining crabs

Last set of samples to extract for the first time!
...
- Samples: 75, 188, 113, 118, 194, 132, 196, 201, 173, 178, 180
- I used 3 µL of ladder for my gel
- PCR Master Mix calculations
  - GoTaq: 12.5 µL x 16 = 200 µL (mix of 4/16 and 4/22)
  - SMC F: 2.5 µL x 16 = 40 µL (mix of 4/16, 4/22, 4/26, and 4/29)
  - SMC R: 2.5 µL x 16 = 40 µL (mix of 4/16, 4/22, 4/26, and 4/29)
  - NF H<sub>2</sub>: 5.5 µL x 14 = 88 µL (mix of 4/16 and 4/22)
- When adding DNA to my PCR master mix, I accidentally added 2 µL of 180 DNA to my extraction blank. I quickly disposed of this tube and added clean PCR MM and 2 µL of the extraction blank to the tube instead. I'm pretty sure I added 180 to the 180 tube, since the 180 PCR tube was closed (PCR tube for the extraction blank was open, which is why I pipetted into it) but the 180 DNA supernatant tube was open.
- When I ran the gel, I noticed the voltage was at 110 instead of 120. This could be why my gel yesterday looked like it needed more time to run even though it was run for the same time as my previous gels. I changed the voltage to 120 for this run.

### Results

![Screenshot 2024-05-16 at 2 25 07 PM](https://github.com/yaaminiv/wc-green-crab/assets/22335838/1dd2337f-2cf4-4d0d-a962-8c9ee14300b3)

**Figure 1**. Gel image for 75, 188, 113, 118, 194, 132, 196, ladder, 201, 173, 178, 180, extraction blank, and PCR blank

Everything looks good, but I once again have a gel that looks like it could have been run for a bit longer! I wonder if I poured the gel too thick or added too much agarose when making the mix this time. I need to rerun 178 and 180. They look fainter than [yesterday's questionable samples](https://yaaminiv.github.io/Green-Crab-Experiment-2023-Part52/), so there's a chance I'll need to re-extract.

### Going forward

1. Troubleshoot five "questionable samples"
