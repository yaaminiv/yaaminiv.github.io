...
layout: post
comments: true
title: West Coast Green Crab Experiment Part 50
tags: green-crab-wc extractions PCR gel
---

## Extraction, PCR, and gel to "redo" crabs

[Tentatively things look okay](https://yaaminiv.github.io/Green-Crab-Experiment-2023-Part49/), so I'm going to try some more extractions! [These are for crabs that started contamination station 3](https://yaaminiv.github.io/Green-Crab-Experiment-2023-Part45/), and consist mainly of crabs with faint gel bands in previous rounds or sampled crabs.
...
- [Knowing that the 4/22 PCR reagents were clean](https://yaaminiv.github.io/Green-Crab-Experiment-2023-Part49/), I used the 4/22 GoTaq and NF H<sub>2</sub>O. I then made up new SMC F and R primers using 45 µL NF H<sub>2</sub>O and 5 µL of the SMC primers and labelled them with the date (4/26)
- Samples: 114, 113, 154, 168, 1, 41, 46, 62, 100. I also decided to [rerun the 4/16 L1 and 4/16 L2 blanks](https://yaaminiv.github.io/Green-Crab-Experiment-2023-Part49/) just to confirm that they look okay. If they look remotely questionable, I'll toss those reagents.
...
<img width="640" alt="Screenshot 2024-04-27 at 3 02 35 PM" src="https://github.com/yaaminiv/wc-green-crab/assets/22335838/17455fc3-ddf8-47c6-ac6b-cd2a8113f433">

**Figure 1**. Gel image for 114, 113, 154, 168, 1, 41, 46, ladder, 62, 100, extraction blank, PCR blank, 4/16 L1, and 4/16 L2

Things still look good! And it's nice to see that the 4/16 extraction blanks also look clean. This means that I can use 4/16 reagents as well!

### Going forward

1. Create list of samples to be extracted each day and set aside samples in a different box
2. Work with Vanessa to continue with Chelex extractions, PCRs, and gels for remaining crabs
