...
layout: post
comments: true
title: West Coast Green Crab Experiment Part 40
tags: green-crab-wc PCR gel
---

## Extractions, PCR, and gel for TTR crabs

Another day of extractions! Originally I thought I'd just do extractions to prepare for PCR with Vanessa tomorrow, but I got to work so early that I just went through the whole protocol.
...
- Samples extracted: 7, 36, 49, 64, 91, 109, 121, 152, 167, 203, 197
...
![Screenshot 2024-02-23 at 2 25 23 PM](https://github.com/yaaminiv/wc-green-crab/assets/22335838/d0288fea-8ba4-405d-9366-b286e75b1314)

**Figure 1**. Gel image for 7, 36, 49, 64, 91, 109, 121, ladder, 152, 167, 203, 197, extraction blank, and PCR blank

Samples look bright enough for sequencing! I noticed that they're smeary (more so than usual). There's a primer-dimer band, but also additional material below. Carolyn said that it was likely unincorporated PCR materials, and not necessarily general smearing from leaving the gel in the rack for too long.
