...
![Screenshot 2024-03-18 at 2 34 01 PM](https://github.com/yaaminiv/wc-green-crab/assets/22335838/eadd503c-9bc7-4dbd-a9c6-4727ba97d722)

**Figure 1**. Gel image for 133, 43, 56, 187, 191, 58, 127, ladder, 157, 59, 44, 189, extraction blank, and PCR blank

Looks good! I think I only have one more set before I'm done with crabs that have samples associated with them!

### Going forward

1. Work with Vanessa to continue with Chelex extractions, PCRs, and gels for TTR crabs with samples
4. Re-extract and PCR samples with faint gel bands
2. Send sample batch 2 for sequencing
3. Finish all extractions with Vanessa
