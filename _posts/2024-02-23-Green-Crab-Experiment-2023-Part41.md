...
layout: post
comments: true
title: West Coast Green Crab Experiment Part 41
tags: green-crab-wc PCR gel
---

## Extractions, PCR, and gel for TTR crabs

I did Chelex extractions before Vanessa arrived, and then Vanessa led PCR! She's doing really well and can run PCR and gel independently from here on out.
...
- Samples extracted: 4, 34, 35, 66, 190, 110, 123, 154, 169, 71, 112
- I may need to re-extract 123 and 154. When I was doing Chelex extractions, I skipped sample 123 and and did 154. When I checked the tubes, looks like I put sample 154 in the right tube since the Chelex tube with 123 was empty. However, I'll just re-extract these just in case.
- While Vanessa did PCR, I reorganized sample boxes! In my box of already-extracted samples, I kept only the the samples that need re-extraction in the box. I moved everything else back into their respective boxes.
...
![Screenshot 2024-02-23 at 3 16 09 PM](https://github.com/yaaminiv/wc-green-crab/assets/22335838/0dfb1b72-b204-4f08-bf17-e20940d8c4bd)

**Figure 1**. Gel image for 4, 34, 35, 66, 190, 110, 123, ladder, 154, 169, 71, 112, extraction blank, and PCR blank

I may need to extract sample 66, but everything else looks good!
...
3. Make 96-well plate sample map for TTR crabs
