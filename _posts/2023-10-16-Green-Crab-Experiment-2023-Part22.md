...
layout: post
comments: true
title: West Coast Green Crab Experiment Part 22
tags: green-crab-wc chelex PCR gel
---

## Extractions, PCR, and gel with third set of respirometry crabs

This is the last set of crabs before I can send a batch of samples off for sequencing!
...
- Samples run: 5-73, 5-131, 5-135, 15-097, 15-160, 25-174, 25-175, 25-179, 25-195
- PCR Master Mix calculations
  - GoTaq: 12.5 µL x 16 = 200 µL
  - SMC F: 2.5 µL x 16 = 40 µL
  - SMC R: 2.5 µL x 16 = 40 µL
  - NF H<sub>2</sub> = 88 µL
- After finishing my Chelex extractions, I immediately loaded the samples into PCR tubes.
- Made new SMC F and SMC R working stock (10 µL 100 µM stock into 90 µL NF H<sub>2</sub>)
- Made more agarose gel mixture (2.00 g agarose powder in 200 mL 1x TAE buffer with 20 µL gel red)

### Results

<img width="785" alt="Screenshot 2023-10-16 at 4 07 46 PM" src="https://github.com/yaaminiv/green-crab-metabolomics/assets/22335838/01c6da0e-08a7-4a78-bce5-8c13dc641cd3">

**Figure 1**. Gel image for 73, 131, 135, 97, 160, 174, ladder, 175, 179, 195, extraction blank, and PCR blank.

Looks like the extraction for sample 160 didn't work! Now that I have done two consistent runs with no contamination in my extraction blank or PCR blank, I'm going to re-extract the [first set of genotyping samples](https://yaaminiv.github.io/Green-Crab-Experiment-2023-Part20/) tomorrow. After that, I can prep my 96-well plate to send out for sequencing!

### Going forward

1. Treatment-wise TTR analysis
3. Treatment-wise respirometry analysis
1. Finish extracting respirometry samples
2. Send samples out for Sanger sequencing
5. Incorporate genotype into respirometry analyses
6. Prepare talk for PICES
1. Continue with Chelex extractions, PCRs, and gels for TTR crabs
