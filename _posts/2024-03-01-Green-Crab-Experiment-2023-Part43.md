...
layout: post
comments: true
title: West Coast Green Crab Experiment Part 43
tags: green-crab-wc PCR gel
---

## Extractions, PCR, and gel for TTR crabs

The goal is to sequence the reamining crabs this month, so let's see how much we can get done before leaving for vacation!
...
![Screenshot 2024-03-05 at 12 42 07 PM](https://github.com/yaaminiv/wc-green-crab/assets/22335838/059d5c80-768b-45f4-943c-00b6728e21a6)

**Figure 1**. Gel image for 133, 43, 56, 187, 191, 58, 127, ladder, 157, 59, 44, 189, extraction blank, and PCR blank

Welp, my extraction blank is contaminated! My PCR blank looks good though, so that tells me that I wasn't careful enough doing my extractions. I'll need to repeat this batch.
